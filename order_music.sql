...
CREATE TABLE IF NOT EXISTS `order_item` (
  ...
  `amount` decimal(10,2) NOT NULL,623
...
INSERT INTO `order_item` (`order_item_id`, `order_id`, `item_id`, `quantity`, `amount`) VALUES
(1, 1, '194397464528', 1, '19.99'),
(2, 1, '194397468724', 1, '12.99');
